export const features = [
  {
    ...
    caption: 'AI-Powered News Synthesis',
    title: 'Transform Information Overload',
    text: "Say goodbye to endless scrolling. Our AI agent automatically curates, summarizes, and transforms daily news into engaging, platform-ready content. It's like having a personal news editor 24/7.",
    button: {
  ...
  },
  {
    ...
    caption: 'Multiformat Content Generation',
    title: 'One Click, Multiple Platforms',
    text: 'Seamlessly create content for LinkedIn, Twitter, Instagram, and more. Our AI generates text posts, memes, images, and short videos – all tailored to your preferred tone and style.',
    button: {
...
export const details = [
  {
    ...
    title: 'AI Automated News Synthesis'
  },
  {
    id: '1',
    icon: '/images/detail-2.png',
    title: 'Multiformat Content Generation'
  },
  {
    id: '2',
