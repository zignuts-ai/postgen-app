    ...
    <section className='bg-gradient-to-t from-zinc-50 to-white dark:from-zinc-950'>
      <div className='mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-24 lg:px-8'>
        <div className='mx-auto max-w-4xl'>
          <h2 className='text-3xl font-bold tracking-tight text-primary sm:text-4xl text-center'>{section.title}</h2>
          <div className='mt-4 text-center text-sm font-semibold tracking-wide'>{section.description}</div>
